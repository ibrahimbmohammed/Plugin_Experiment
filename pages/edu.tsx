...
function cookyPolicy() {
  return (
    <div className="flex flex-col items-start justify-center space-y-6 px-8">
      <h1 className="mt-5 self-center text-2xl text-primaryColor">
        Cookies Policy
      </h1>
      <p className="font-semibold">Last updated: October 17, 2022</p>
      <p>
      ...
      <ul className="space-y-2">
        ...
        <li>
          <strong>Website</strong> refers to peddlesoft, accessible from{" "}
          <a
            href="www.peddlesoft.com"
      ...
      <h1 className="pt-4 font-bold">The use of the Cookies</h1>
      <h2 className="font-semibold">Type of Cookies We Use</h2>
      <p>
      ...
      <h2 className="font-semibold">Your Choices Regarding Cookies</h2>
      <p>
...
export default HomeWrapper(cookyPolicy);
