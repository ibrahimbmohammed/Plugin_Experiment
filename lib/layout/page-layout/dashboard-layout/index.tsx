...
import NavItems from '@lib/constants/dashboard/sidebar/NavItems';
import WithDashboard from '@lib/hoc/dashboard-wrapper';
...
import { fetchAndSetOrganizationProfessionalData } from '@store/dashboard/dashboard-org-data';
...
function DashboardLayout({ children }: IDashboardLayoutProps) {
    ...
    // Fetch User Data
    useCheckSliceBeforeFetch<FetchUserDataQueryQuery>('/api/user-data/', 'userData', setUserData);

    // Fetch Organization Professional Data
    const dispatch = useAppDispatch();
    dispatch(fetchAndSetOrganizationProfessionalData());
    // Fetch organization payment data
